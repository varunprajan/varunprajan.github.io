...
We should try to change the mathematics of credit and blame in data orgs. You should get credit for discovering problems with data quality, or helping to build data tools, or making a really nice-to-use, clean dataset. Of course, the pendulum can swing too far the other direction, where everyone tries to develop tools that they want others to use. But my point is that we should be more precise about apportioning success. If you couldn’t have done your project without others, that should count towards promotion packages, or at least bonuses, too.
...
I’m not going to lie — that sounds slightly daunting, and I often think it would be easier if I stuck to my usual way of doing things (which has worked for the last 10 years or so).
...
I don’t always side with the workers, but I understand why they pursue self-interest. After all, everyone else does it. An employer doesn’t care about you, despite how much they might talk about “family” and “community”. So why should the reciprocal relationship be any different?
